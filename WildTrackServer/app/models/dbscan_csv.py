...
import pickle
from csv_load import load_from_csv
...
if __name__ == "__main__":
    gps_data, species_list, timestamps = load_from_csv('data/data.csv')
    
    if species_list is None:
        print("ERROR: No species data found in CSV!")
        exit(1)
    ...
    test_points = [
        ...
        (gps_data[100][0], gps_data[100][1], species_list[100]),
        (gps_data[1000][0], gps_data[1000][1], species_list[1000])
    ]
